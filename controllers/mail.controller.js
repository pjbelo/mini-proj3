...
function sendMail(req, res) {
  ...
  if (errors) {
    ...
    if (
      ...
      bodycontent +=
        "Agradecemos o seu contacto!" + "<br>" + "Obrigado!" + "<br>" + "<br>";
      ...
      bodycontent +=
        '<img src="https://fcawebbook.herokuapp.com/assets/images/mail.png" alt="mail.icon" height="42" width="42">';
      ...
      res
        ...
        .send(jsonMessages.mail.requiredData);
  }
}
//exportar as funções
module.exports = {
